...
🤝  A tool for connecting subcommunities on a given campus developed with flet. 

## flet-demo/

🧪  I wrote a quick flet demo application to show basic functionality of the library and familiarize myself with its use.

## requirements.txt

📝  In order to set up your own environment to run this project, run the following commands:
    ...
    The requirements.txt file contains all dependencies required for the project to run. I created it with the command pip freeze > requiremnets.txt.
